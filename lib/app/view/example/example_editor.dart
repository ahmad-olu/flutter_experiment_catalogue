...
import 'package:experiment_catalogue/app/view/example/_toolbar.dart';
...
class GlobalStyleEdit {
  GlobalStyleEdit({
    required this.defaultColor,
    required this.defaultHighlightColor,
  });

  factory GlobalStyleEdit.init() => GlobalStyleEdit(
        defaultColor: Colors.black,
        defaultHighlightColor: Colors.black,
      );

  final Color defaultColor;
  final Color defaultHighlightColor;

  GlobalStyleEdit copyWith({
    Color? defaultColor,
    Color? defaultHighlightColor,
  }) {
    return GlobalStyleEdit(
