...
import 'package:experiment_catalogue/app/view/example/super_editor_item_selector.dart';
    ...
    return _PositionedToolbar(
      ...
      child: ValueListenableBuilder<DocumentSelection?>(
        ...
        builder: (context, selection, child) {
          dev.log("Building image toolbar. Selection: $selection");
          if (selection == null) {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<Offset?>(
      ...
      builder: (context, offset, _) {
        dev.log("(Re)Building _PositionedToolbar widget due to anchor change");
        if (offset == null || composer.selection == null) {
          dev.log("Anchor is null. Building an empty box.");
          // When no anchor position is available, or the user hasn't
          // selected any text, show nothing.
          return const SizedBox();
        }

        dev.log("Anchor is non-null: $offset, child: $child");
