import 'package:experiment_catalogue/applications/08_notes/infrastructure/selectable_grid.dart';
...
class ColorSelector extends StatefulWidget {
  ...
  final Widget Function(BuildContext context, Color? selectedColor)
      colorButtonBuilder;
...
class _ColorSelectorState extends State<ColorSelector> {
    ...
    return SizedBox(
      ...
      child: TextButton.icon(
        ...
        style: ButtonStyle(
          ...
          backgroundColor: WidgetStateProperty.resolveWith((a) => Colors.red),
  ...
  Widget _buildPopoverGridItem(
      BuildContext context, Color item, bool isActive, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
  ...
  Widget _buildCustomColorsButton() {
    return SizedBox(
      ...
      child: TextButton(
        ...
        style: ButtonStyle(
          foregroundColor: WidgetStateProperty.all(Colors.black),
          backgroundColor: WidgetStateProperty.resolveWith((a) => Colors.blue),
          padding: WidgetStateProperty.all(const EdgeInsets.all(5)),
          shape: WidgetStateProperty.all(
            const RoundedRectangleBorder(
              borderRadius: BorderRadius.all(Radius.circular(5)),
