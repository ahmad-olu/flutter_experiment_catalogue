import 'package:experiment_catalogue/applications/08_notes/page/note.dart'
    show defaultToolbarButtonStyle;
...
class _TextItemSelectorState extends State<TextItemSelector> {
  ...
  final WidgetStatesController _buttonStatesController =
  ...
  void _onPopoverVisibilityChange() {
    _buttonStatesController.update(
        WidgetState.pressed, _popoverController.shouldShow);
  }
  ...
  Widget build(BuildContext context) {
    return PopoverScaffold(
      ...
      popoverGeometry: widget.popoverGeometry ??
  ...
  Widget _buildButton(BuildContext context) {
    final size =
        WidgetStateProperty.all(widget.buttonSize ?? const Size(97, 30));
    return Stack(
...
Widget defaultPopoverListItemBuilder(
    BuildContext context, TextItem item, bool isActive, VoidCallback onTap) {
  return DecoratedBox(
...
class TextItem {
  ...
  bool operator ==(Object other) =>
      ...
      other is TextItem && runtimeType == other.runtimeType && id == other.id;
